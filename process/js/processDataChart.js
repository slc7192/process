...
// 参数说明 eve图表的dom元素  
// x x轴数据  y y轴数据 a图表标题  b曲线名称 c y轴坐标说明 d 缩略图的开始位置 e 缩略图的介绍位置
function init(eve, x, y, a, b, c, d, e) {
...
// 点击导入历史数据   由土样的选框判断是哪一组数据 然后执行函数
$(".new_data").on("click", function() {
  ...
  if ($("select[name='testNumber']").val() == 1) {
      //沉降量**********************************
      var downx=[];
      // 液体**********************
      var lyx =[];
    ...
    init("down", downx, downy, "沉降量关系图", "沉降量", "沉降量mm", 15, 30);
    init("tem", temx, temy, "温度关系图", "温度", "温度/摄氏度", 45, 60);
    init("load", loadx, loady, "加载力关系图", "加载力", "加载力KG", 40, 60);
    init("liquid",lyx,lyy,"液体流量关系图","液体流量","液体流量mm",10,30);
    init("gas", mx, my, "废气量关系图", "废气量", "废气量ml", 0, 26);

  } else if ($("select[name='testNumber']").val() == 2) {
    // 沉降
    //沉降量**********************************
    var downx=[];
    // 液体**********************
   ...
   for (var i = result.length - 1; i >= 0; i--) {
    ...
    init("down", downx, downy, "沉降量关系图", "沉降量", "沉降量mm", -1, 8);
    init("tem", temx, temy, "温度关系图", "温度", "温度/摄氏度", 20, 30);
    init("load", loadx, loady, "加载力关系图", "加载力", "加载力KG", 42, 47);
    init("liquid", lyx, lyy, "液体流量关系图", "液体流量", "液体流量mm", 0, 25);
    init("gas", mx, my, "废气量关系图", "废气量", "废气量ml", 0, 6);
  }
